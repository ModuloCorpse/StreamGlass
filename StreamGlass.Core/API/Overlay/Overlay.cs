...
namespace StreamGlass.Core.API.Overlay
{
    public class Overlay(string name) : Directory
    {
        ...
        public void AddRootAssemblyResource(string resourcePath, string assemblyPath, MIME? mime = null) => AddResource(new Path(resourcePath), new AssemblyResource(false, null, assemblyPath, mime), true);
        public void AddRootAssemblyResource(Path resourcePath, string assemblyPath, MIME? mime = null) => AddResource(resourcePath, new AssemblyResource(false, null, assemblyPath, mime), true);
        public void AddAssemblyResource(string resourcePath, string assemblyPath, MIME? mime = null) => AddResource(new Path(resourcePath), new AssemblyResource(false, null, assemblyPath, mime), false);
        public void AddAssemblyResource(Path resourcePath, string assemblyPath, MIME? mime = null) => AddResource(resourcePath, new AssemblyResource(false, null, assemblyPath, mime), false);
