...
namespace StreamGlass.Core.Controls
{
    public class GroupBox : System.Windows.Controls.GroupBox, IUIElement
    {
        ...
        public static readonly DependencyProperty TranslationKeyProperty = Helper.NewProperty<GroupBox, string>("TranslationKey", string.Empty, (elem, key) => elem.UpdateTranslationKey(key));
